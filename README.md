---
description: The everyday Bitcoin wallet born in El Zonte
---

# What is Blink?

[Blink](https://blink.sv/) (formerly Bitcoin Beach Wallet) is a Bitcoin wallet designed to enable bottom-up bitcoin adoption around the world. Whether you're a beginner or an expert, a shopper or a merchant, Blink's feature set makes it a must-have wallet on any phone.

* **Great for onboarding**: Blink is great for onboarding with easy setup and educational lessons, making it the perfect wallet to recommend to friends, family, or anyone new to Bitcoin. As a custodial wallet with trial account option, new users can try Bitcoin without immediate seed phrase storage requirements.
...
* **Stablesats:** With a USD denominated wallet powered by Stablesats, Blink is also a great tool for keeping your sats at dollar value helping your short-term financial plans and accounting. Learn more at [stablesats.com](https://stablesats.com). There is an easy way to convert the amount of choice between your bitcoin and dollar denominated wallets.
...
* **Open source:** True to the Bitcoin ethos, Blink is free open source software (FOSS) built on the Lightning development platform maintained by Blink. View the code on [GitHub](https://github.com/blinkbitcoin)
...
*   **Additional useful features:**
    ...
    \- For developers and automation needs there is a public API available. Learn more at [dev.blink.sv](https://dev.blink.sv)
