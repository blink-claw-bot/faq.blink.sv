...
* **Open source:** True to the Bitcoin ethos, Blink is free open source software (FOSS) built on the Lightning development platform maintained by Galoy. View the code on [GitHub](https://github.com/blinkbitcoin)
