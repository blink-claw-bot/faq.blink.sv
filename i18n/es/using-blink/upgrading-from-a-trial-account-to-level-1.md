...
Una cuenta de prueba tiene límites de transacciones bajos y no se permite enviar ni recibir en la cadena de bloques.
...
2. seleccionar `Email (para iniciar sesión)`
