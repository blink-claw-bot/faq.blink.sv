...
* Para recibir en Lightning, toca `Recibir Bitcoin via Lightning` y muestra el código QR al pagador.

## Chivo ATM
* Los cajeros automáticos de Chivo reciben solo de billeteras externas en la cadena, lo cual puede ser costoso y lento.
* Si tienes una billetera Chivo, puedes retirar efectivo del cajero automático sin cargo.
* Para utilizar el cajero automático sin cargo con los fondos en la billetera Blink, utiliza Lightning para transferir tus fondos a la billetera Chivo y retira del cajero automático.

## Infografía para recibir en Lightning con la billetera Chivo.
![Recibir en lightning con Chivo](/.gitbook/assets/chivo_receive_on_lightning.png)
