---
description: La billetera de Bitcoin cotidiana nacida en El Zonte
---

# ¿Qué es Blink?

[Blink](https://blink.sv/) (anteriormente Bitcoin Beach Wallet) es una billetera de Bitcoin diseñada para permitir la adopción de bitcoin de abajo hacia arriba en todo el mundo. Ya sea que seas principiante o experto, comprador o comerciante, el conjunto de funciones de Blink lo convierte en una billetera imprescindible en cualquier teléfono.

* **Ideal para la incorporación**: Blink es ideal para la incorporación con una configuración sencilla y lecciones educativas, lo que lo convierte en la billetera perfecta para recomendar a amigos, familiares o cualquier persona nueva en Bitcoin. Los nuevos usuarios pueden probar Bitcoin sin necesidad inmediata de almacenar una frase de semilla.
...
* **Código abierto:** Fiel al ethos de Bitcoin, Blink es software de código abierto gratuito (FOSS) construido sobre la plataforma de desarrollo Lightning mantenida por Galoy. Ver el código en [GitHub](https://github.com/blinkbitcoin)
...
* **Elige tu moneda de visualización**: Establece en qué moneda quieres ver tu saldo en sats y dólares. Más de 30 monedas disponibles, y próximamente habrá más.
*   **Características adicionales útiles:**

    \- Sin comisión de transacción cuando tanto el remitente como el receptor utilizan Blink
