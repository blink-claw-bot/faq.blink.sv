...
When you receive an **on-chain transaction** in your Bitcoin wallet in Blink, there is no fee charged if you are receiving an amount higher than 1 million satoshis. Below the 1 million limit there is a 2500 sats fee for receiving on-chain. Note that to be notified about an onchain payment received it needs to be at least **3046 sats** (the dust threshold 546 sats + the minimum deposit fee 2500 sats). Consider using Lightning to receive small payments where there is no minimum amount.
